...
export class FormbuilderComponent implements OnInit {
	...
	viewFormDetail(onSelectedRow: IForm) {
		...
		console.log("[FormbuilderComponent::viewFormDetail] : currSelectedForm : ", JSON.stringify(this.currSelectedForm));
	}

	submitIForm(form: IForm) {
		console.log("[FormbuilderComponent::submitIForm] : form : ", JSON.stringify(form));
